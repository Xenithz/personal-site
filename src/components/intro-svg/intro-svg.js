...
import Logo from './undraw_code_thinking_1jeh.png';
...
export const IntroSvg = () => {
    return (
        <motion.div className={styles.introSVGContainer} initial="initial" animate="animate" transition={{delay: 1.75}} variants={righty}>
